(() => {
  ...
  const documents = {
    home: `
      <div class="prd-summary"><span>页面目标<b>快速发起教学任务</b></span><span>核心入口<b>＋ / AI组题 / 题库</b></span><span>结果承接<b>当前对话</b></span></div>
      <section class="prd-section">
        <h3>1. 页面定位与范围 <span class="prd-status">P0</span></h3>
        <p>首页是教学任务的统一入口。本期新增题库加题能力，但不改变已有教学技能、资源广场、工作区和输入框结构。</p>
        <h4>主流程</h4>
      ...
      <section class="prd-section">
        ...
        <div class="prd-table-wrap"><table class="prd-table"><thead><tr><th>控件</th><th>触发与结果</th><th>状态/约束</th></tr></thead><tbody>
          <tr><td>＋ 添加</td><td>弹出来源菜单：上传文件、从题库中添加、从知识库添加。</td><td>再次点击或点空白区关闭；不清空输入框。</td></tr>
          <tr><td>AI组题</td><td>激活组题技能，保留首页输入态；此后＋仍可从题库加题。</td><td>高亮技能；可取消；已选题保留。</td></tr>
    ...
    knowledge: `
      <div class="prd-summary"><span>页面目标<b>沉淀与复用个人资产</b></span><span>新增目录<b>我的组题</b></span><span>查看方式<b>知识库内预览</b></span></div>
      <section class="prd-section">
        <h3>1. 页面定位与目录 <span class="prd-status">P0</span></h3>
        <p>首页点击“我的知识库”进入“我的云盘”。在“我的工作成果”下新增“我的组题”系统文件夹，用于汇总用户保存的组题画布和所有AI组题题单。</p>
