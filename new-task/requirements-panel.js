  ...
  const documents = {
    ...
    workbench: `
      ...
      <section class="prd-section">
        ...
        <p>飞象题库为新增页面。左侧负责找题、预览题源与 AI 组题过程，右侧为当前题单画布。左侧顶部为<strong>来源页签栏</strong>：返回、飞象象标（无「飞象题库」文字）、学段学科下拉，固定「飞象题库」「组题工具」「我的题库」，以及由组题工具衍生的<strong>可关闭动态页签</strong>（规则见 §2）。</p>
      ...
      <section class="prd-section">
        ...
        <div class="prd-table-wrap"><table class="prd-table"><thead><tr><th>类型</th><th>示例</th><th>关闭</th></tr></thead><tbody>
          <tr><td>固定页签</td><td>飞象题库、组题工具、我的题库</td><td><strong>不可</strong>关闭；始终位于栏最左侧（飞象象标与学段学科下拉之后）。</td></tr>
